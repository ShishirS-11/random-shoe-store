    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto p-8 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {shoes?.map((shoe) => (
            <div key={shoe.id} className="bg-brand-gray group rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-brand-purple/20">
